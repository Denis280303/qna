...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<redis>.freeze, ["~> 3.2", ">= 3.2.1"])
    s.add_runtime_dependency(%q<connection_pool>.freeze, ["~> 2.2", ">= 2.2.0"])
    ...
    s.add_development_dependency(%q<minitest>.freeze, ["~> 5.10", ">= 5.10.1"])
    ...
    s.add_dependency(%q<redis>.freeze, ["~> 3.2", ">= 3.2.1"])
    s.add_dependency(%q<connection_pool>.freeze, ["~> 2.2", ">= 2.2.0"])
    s.add_dependency(%q<concurrent-ruby>.freeze, ["~> 1.0"])
    s.add_dependency(%q<rack-protection>.freeze, [">= 1.5.0"])
    s.add_dependency(%q<redis-namespace>.freeze, ["~> 1.5", ">= 1.5.2"])
    s.add_dependency(%q<minitest>.freeze, ["~> 5.10", ">= 5.10.1"])
