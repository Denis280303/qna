...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<shoulda>.freeze, [">= 2.1.1"])
    ...
    s.add_dependency(%q<activesupport>.freeze, [">= 2.3.4"])
    s.add_dependency(%q<shoulda>.freeze, [">= 2.1.1"])
